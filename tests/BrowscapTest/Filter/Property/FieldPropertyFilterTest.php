...
class FieldPropertyFilterTest extends TestCase
{
    ...
    public function testIsOutput(string $propertyName, bool $isExtra): void
    {
        ...
        $object = new FieldPropertyFilter($propertyHolder, ['Parent']);
        ...
        static::assertSame($isExtra, $object->isOutput($propertyName, $mockWriterIni));
    }
     ...
     * @dataProvider outputPropertiesDataProvider
     */
    public function testIsOutputModified(string $propertyName): void
    {
        $propertyHolder = $this->getMockBuilder(PropertyHolder::class)
            ->disableOriginalConstructor()
            ->onlyMethods(['isOutputProperty'])
